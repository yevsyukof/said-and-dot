...
func GetUserByID(id string, db postgres.Store) (*entities.User, error) {
	var userExists bool
...
func GetUserTweets(user *entities.User, db postgres.Store) ([]entities.Tweet, error) {
	var foundTweetsRecords postgres.Rows
...
func GetTweetFavorites(tweetID uuid.UUID, db postgres.Store) (*[]uuid.UUID, error) {
	tweetFavorites := new([]uuid.UUID)

	var foundTweetFavorites postgres.Rows
...
func GetAllTweets(db postgres.Store) (*[]entities.TweetWithAuthor, error) {
	var tweetsRecords postgres.Rows
...
func GetFollowersByUserID(userID uuid.UUID, db postgres.Store) (*[]uuid.UUID, error) {
	userFollowers := new([]uuid.UUID)

	var foundUserFollowers postgres.Rows
...
func GetFollowsByUserID(userID uuid.UUID, db postgres.Store) (*[]uuid.UUID, error) {
	userFollows := new([]uuid.UUID)

	var foundUserFollows postgres.Rows
...
func SaveNewTweet(tweet *entities.Tweet, db postgres.Store) error {
	if _, err := db.Exec(
